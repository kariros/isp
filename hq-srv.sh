...
# Пользователь (администратор), SSH, SELinux, DNS master
# =====================================================
...
read -p "Введите имя пользователя (например, sshuser): " ADMIN_USER
...
echo "✅ SSH настроен: порт $SSH_PORT, MaxAuthTries $SSH_TRIES, доступен пользователь $ADMIN_USER"
