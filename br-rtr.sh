...
# Настройка ens192 + GRE туннель + FRR/OSPF
# =====================================================
...
read -p "Введите шлюз по умолчанию (если есть, иначе пусто): " GW_ENS192
read -p "Введите DNS-серверы (через пробел, например 8.8.8.8 1.1.1.1): " DNS_ENS192
...
# 5. nftables (masquerade через ens192)
